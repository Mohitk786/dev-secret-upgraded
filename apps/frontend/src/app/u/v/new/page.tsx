    ...
    <>
      ...
      <Card className="border-primary/10">
        <CardHeader>
          ...
          <CardDescription>
            Configure your new vault&apos;s properties
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  A brief description of what this vault will contain
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Select an icon that represents this vault
                </p>
              </div>
            </div>
