...
import { useSignupMutation, useUploadPublicKeyMutation } from "@/hooks/mutations/authMutaions"
...
const Register = () => {
  ...
  return (
    <AuthForm title="Create your KeyVault account" description="Secure your dev secrets in one powerful vault 🚀">
      <form className="space-y-6" onSubmit={handleSubmit} autoComplete="off">
        ...
        <InputField
          ...
          required
        />
        <SubmitButton isPending={isPending} text={isPending ? "Creating account..." : "Create Account"} />
      </form>
